...
function findWasmBinary() {
  return locateFile('particle_sim.wasm');
}
...
var ASM_CONSTS = {
  98813: () => { if (document.fullscreenElement) return 1; },  
 98859: () => { return Module.canvas.width; },  
 98891: () => { return parseInt(Module.canvas.style.width); },  
 98939: () => { document.exitFullscreen(); },  
 98966: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 99038: () => { if (document.fullscreenElement) return 1; },  
 99084: () => { return Module.canvas.width; },  
 99116: () => { return screen.width; },  
 99141: () => { document.exitFullscreen(); },  
 99168: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 99301: () => { return window.innerWidth; },  
 99327: () => { return window.innerHeight; },  
 99354: () => { if (document.fullscreenElement) return 1; },  
 99400: () => { return Module.canvas.width; },  
 99432: () => { return parseInt(Module.canvas.style.width); },  
 99480: () => { if (document.fullscreenElement) return 1; },  
 99526: () => { return Module.canvas.width; },  
 99558: () => { return screen.width; },  
 99583: () => { return window.innerWidth; },  
 99609: () => { return window.innerHeight; },  
 99636: () => { if (document.fullscreenElement) return 1; },  
 99682: () => { return Module.canvas.width; },  
 99714: () => { return screen.width; },  
 99739: () => { document.exitFullscreen(); },  
 99766: () => { if (document.fullscreenElement) return 1; },  
 99812: () => { return Module.canvas.width; },  
 99844: () => { return parseInt(Module.canvas.style.width); },  
 99892: () => { document.exitFullscreen(); },  
 99919: ($0) => { Module.canvas.style.opacity = $0; },  
 99957: () => { return screen.width; },  
 99982: () => { return screen.height; },  
 100008: () => { return window.screenX; },  
 100035: () => { return window.screenY; },  
 100062: () => { return window.devicePixelRatio; },  
 100098: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100151: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 100202: () => { Module.canvas.style.cursor = 'none'; },  
 100239: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100495: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 100546: () => { if (document.pointerLockElement) return 1; },  
 100593: () => { if (document.fullscreenElement) return 1; },  
 100639: () => { return window.innerWidth; },  
 100665: () => { return window.innerHeight; }
};
